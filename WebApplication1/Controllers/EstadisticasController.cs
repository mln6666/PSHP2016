            ...
            if (contadorvenc.CantVenc > contadorvenc.CantVencAnt)
            {
                ...
                foreach (var item in listaPs)
                {
                    if (item.Vencimiento < DateTime.Now)
                    {
                        ...
                        holi.Append("</td><td style=\" border-color:#5c87b2; border-style:solid; border-width:thin; padding: 5px;\">" + item.Alumno.Legajo + "</td><td style=\" border-color:#5c87b2; border-style:solid; border-width:thin; padding: 5px;\">" + item.Alumno.ApellidoAlu);
